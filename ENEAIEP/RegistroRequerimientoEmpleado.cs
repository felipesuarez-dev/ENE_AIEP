...
namespace ENEAIEP
{
    public partial class RegistroRequerimientoEmpleado : Form
    {
        ...
        public RegistroRequerimientoEmpleado(string nombre, string apellido)
        {
            InitializeComponent();
            txtAsignadoPorE.Visible = false;
        ...
        private void btnIrListaRequerimientosE_Click(object sender, EventArgs e)
        {
            ...
            lre.txtUsuAct.Text = txtAsignadoPorE.Text;
            lre.Show();
        }
